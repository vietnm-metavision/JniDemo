...
LIB_VERSION="OpenSSL_1_1_1g"
LIB_NAME="openssl-1.1.1g"
LIB_DEST_DIR="${pwd_path}/../output/android/openssl-universal"

log_info "Downloading ... https://www.openssl.org/source/${LIB_NAME}.tar.gz"
