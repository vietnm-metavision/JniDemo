...
function set_android_toolchain_bin() {
  ...
  export PATH=$PATH:${ANDROID_NDK_ROOT}/toolchains/x86-4.9/prebuilt/linux-x86_64/bin
  export PATH=$PATH:${ANDROID_NDK_ROOT}/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin
  export PATH=$PATH:${ANDROID_NDK_ROOT}/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/bin
  #echo PATH=$PATH
}
